    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    I codici di recupero ti permettono di accedere se perdi il
                    dispositivo 2FA. Conservali in un gestore di password
                    sicuro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        una sola volta per accedere e verrà
                                        rimosso dopo l’uso. Se te ne servono
                                        altri, seleziona{' '}
