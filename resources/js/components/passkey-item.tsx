    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        {passkey.last_used_at_diff && (
                            <>
                                ...
                                Ultimo utilizzo {passkey.last_used_at_diff}
                            </>
                        )}
                    </p>
                </div>
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>Rimuovi passkey</DialogTitle>
                    <DialogDescription>
                        Vuoi rimuovere la passkey “{passkey.name}”? Non potrai
                        più usarla per accedere.
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'Rimozione...' : 'Rimuovi passkey'}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
